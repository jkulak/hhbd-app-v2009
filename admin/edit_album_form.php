...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="left"> 
      <form action="edit_album.php" method="get" name="add_album" target="_self" enctype="multipart/form-data">
          ...
          <tr> 
            <td colspan="3" height="180" valign="top" align="left"> 
              <p><b>OPIS PRODUKCJI</b><br>
                <textarea name="description" rows="6" style="width: 280px"><?php print($albumrow['description']); ?></textarea>
                <br>
